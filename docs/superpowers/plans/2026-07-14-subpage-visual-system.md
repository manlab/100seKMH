...
**Goal:** Give all 26 visible submenu pages a route-specific hero background and a contextual content image using supplied hospital photography and safe generated editorial healthcare imagery.
...
- Cover the 26 visible dropdown pages listed in `docs/superpowers/specs/2026-07-14-subpage-visual-system-design.md`.
...
- [ ] Add the exact 26 required dropdown paths to `verify-subpage-visuals.mjs`.
...
- Modify: `apps/web/app/autonomic/{self-check,care}/page.tsx`
...
- Modify: `apps/web/app/diet/{causes,guide}/page.tsx`
...
- [ ] Run `npm run verify:subpage-visuals`. Expected: `Verified 26 submenu visual assignments` and zero missing assets.
