...
export default function SpineJointDiscPage() { return <ClinicalGuidePage category="척추관절통증" categoryEyebrow="SPINE & JOINT CARE" categoryHref={ROUTES.spineJoint.root} lnbItems={items} visualPath={ROUTES.spineJoint.disc} {...guide} />; }
