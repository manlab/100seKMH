...
export default function CancerPostSurgeryPage() {
  return (
    <ClinicalGuidePage
      ...
      overview="수술 후 회복기에 느끼는 불편은 수술 부위, 치료 경과, 기존 질환, 복용 중인 약에 따라 다릅니다. 진료 시 현재 불편과 생활 변화를 확인하고 필요한 상담을 안내합니다."
      topics={[
        { title: "현재 불편 확인", description: "통증, 피로, 식사와 수면 변화처럼 회복기에 느끼는 불편을 함께 확인합니다.", href: ROUTES.cancer.postSurgery },
        { title: "치료 이력 확인", description: "수술 내용과 이후 치료 계획, 복용 중인 약을 확인해 상담 방향을 정합니다.", href: ROUTES.cancer.postSurgery },
        { title: "생활 관리 상담", description: "일상 복귀 과정에서 궁금한 점을 확인하고 개별 상태에 맞춰 안내합니다.", href: ROUTES.cancer.postSurgery },
      ]}
