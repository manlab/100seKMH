...
export function HomeLayerPopups({ items }: { items: HomePopupView[] }) {
  ...
  const hasCta = Boolean(current.linkLabel && current.linkUrl);
  ...
  return (
    ...
    >
      <section
        role="dialog"
        aria-modal="true"
        aria-labelledby={`home-popup-title-${current.id}`}
      ...
      >
        ...
        <div className="p-6 sm:p-8">
          <p className="text-[12px] font-semibold tracking-[0.18em] text-accent-600">NOTICE</p>
          <h2
          ...
          <div className="mt-6 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
            ...
            {hasCta && current.linkUrl && current.linkLabel &&
